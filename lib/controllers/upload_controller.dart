...
class UploadController extends GetxController {
  ...
  saveVideoInfo(String artistSongName, String descriptionTags,
    ...
    try {
      ...
      String videoDownloadUrl =
          await uploadCompressVideoFile(videoID, videoFilePath);
      String thumbnailDownloadUrl =
          await uploadVideoThumbnailImage(videoID, videoFilePath);
